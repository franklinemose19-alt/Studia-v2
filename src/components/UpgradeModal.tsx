...
const PLANS = [
  { id: 'achiever', emoji: '🎯', name: 'Achiever', price: 'KSh 45', perks: ['45 AI minutes', 'Recording + transcription', 'AI notes & summary'] },
  { id: 'achiever-plus', emoji: '🎯', name: 'Achiever+', price: 'KSh 69', perks: ['90 AI minutes', 'Recording + transcription', 'AI notes & summary'] },
