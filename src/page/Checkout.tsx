            ...
            >
              ...
              <div className="space-y-6">
                <div className="pb-6 border-b border-gray-200">
                  ...
                  {selectedPlan.period && (
                    <p className="text-sm text-gray-600 mt-1">{selectedPlan.period}</p>
                  )}
                </div>
                ...
                <div className="pt-6 border-t-2 border-gray-200">
                  <div className="flex justify-between items-center">
                    ...
                    <p className="font-sora font-bold text-4xl text-indigo-premium">
                ...
                <div className="bg-mint/10 border border-mint/20 rounded-xl p-4 mt-6">
                  ...
                  <p className="text-xs text-gray-600 mt-1">
                    Payment held securely. Released after activation.
                  </p>
                </div>
              </div>
            </motion.div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
                    ...
                    <ol className="text-xs text-blue-600 space-y-1">
                      ...
                      <li>4. Instant activation on your account</li>
                    </ol>
                  </div>
                  ...
                  <p className="text-center text-xs text-gray-500">
                    Your payment is 100% secure and protected by M-Pesa escrow.
                  </p>
                </div>
              ) : status === 'processing' ? (
                <div className="flex flex-col items-center justify-center py-12">
                  <Loader className="animate-spin text-indigo-premium mb-4" size={40} />
                  <p className="font-sora font-bold text-navy mb-2">Processing Payment</p>
          ...
          <div className="bg-white rounded-2xl border border-gray-200 p-8">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Instantly after successful payment. You get immediate access.</p>
              </div>
            </div>
          </div>
        </motion.div>
