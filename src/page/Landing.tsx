    ...
    <div className="min-h-screen bg-white overflow-hidden">
      ...
      <section className="pt-28 sm:pt-36 pb-16 sm:pb-24 px-4 sm:px-6 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10 text-center">
          ...
          >
            {isInstalled ? (
              <div className="inline-flex items-center gap-2 bg-emerald-50 border border-emerald-200 text-emerald-700 px-7 py-3 rounded-xl font-bold text-sm shadow-sm">
                <Check size={18} />
                STUDIA AI Installed
              </div>
            ) : (
              <button
                ...
                className="inline-flex items-center justify-center gap-2 bg-gradient-to-r from-indigo-premium to-purple-premium text-white px-7 py-3 rounded-xl font-bold text-sm shadow-lg shadow-indigo-premium/25 hover:scale-[1.02] hover:shadow-xl transition-all duration-200 disabled:opacity-60 disabled:cursor-not-allowed"
              >
                {isInstalling ? (
                  <>
                ...
                {plan.badge && (
                  <span
                    className={`absolute -top-3 left-1/2 -translate-x-1/2 px-3 py-0.5 rounded-full text-xs font-bold text-white whitespace-nowrap ${
                      plan.highlight ? 'bg-warning' : 'bg-light-blue'
                    }`}
                  >
                    {plan.badge}
                  </span>
          ...
          <div className="space-y-4">
            {[
              ...
              },
              {
                ...
                a: 'AI generation features lock permanently — no reset. Upgrade to Achiever, Excellence, or Valedictorian for more AI lectures.',
              },
              {
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          {!isInstalled && (
            <button
              ...
              onClick={install}
              disabled={isInstalling}
              className="mx-auto flex items-center justify-center gap-2 bg-white text-indigo-premium px-7 py-3 rounded-xl font-bold text-sm hover:bg-gray-100 transition shadow-lg disabled:opacity-60 disabled:cursor-not-allowed"
            >
              {isInstalling ? (
                <>
                  <div className="w-4 h-4 border-2 border-indigo-premium/30 border-t-indigo-premium rounded-full animate-spin" />
                  Installing STUDIA...
                </>
              ) : (
                <>
          ...
          {isInstalled && (
            <div className="mx-auto inline-flex items-center justify-center gap-2 bg-white/15 border border-white/30 text-white px-6 py-3 rounded-xl font-semibold text-sm">
              <Check size={18} />
