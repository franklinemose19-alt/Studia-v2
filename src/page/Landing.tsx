    ...
    <div className="min-h-screen bg-white overflow-hidden">
      ...
      <section className="pt-28 sm:pt-36 pb-16 sm:pb-24 px-4 sm:px-6 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10 text-center">
          ...
          >
            {isInstalled ? (
              <div className="flex items-center gap-2 bg-mint/10 border border-mint/20 text-mint px-6 py-3 rounded-2xl font-semibold text-sm">
                <Check size={17} />
              ...
              <button
                ...
                className="group flex items-center gap-3 bg-white border-2 border-indigo-premium/20 text-navy px-7 py-3.5 rounded-2xl font-bold text-sm shadow-lg shadow-indigo-premium/10 hover:border-indigo-premium hover:shadow-xl hover:-translate-y-0.5 transition-all duration-200 disabled:opacity-60"
              >
                <span className="w-9 h-9 rounded-xl bg-gradient-to-br from-indigo-premium to-purple-premium flex items-center justify-center shadow-md group-hover:scale-105 transition">
      ...
      <section className="py-20 sm:py-24 px-4 sm:px-6 bg-gradient-to-br from-indigo-premium to-purple-premium text-white">
        <div className="max-w-3xl mx-auto text-center">
          ...
          {/* Permanent download button in CTA */}
          {!isInstalled && (
            <button
              onClick={handleInstall}
              disabled={isInstalling}
              className="mx-auto flex items-center justify-center gap-3 bg-white/10 border border-white/30 text-white px-7 py-3.5 rounded-2xl font-bold text-sm hover:bg-white/20 transition disabled:opacity-50"
            >
              {isInstalling ? (
                <>
                  <div className="w-4 h-4 border-2 border-white/30 border-t-white rounded-full animate-spin" />
