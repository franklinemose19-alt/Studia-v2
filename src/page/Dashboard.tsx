...
import {
  loadAccess,
  explorerLecturesRemaining,
  paidLecturesRemaining,
  getPlanLabel,
  getPlanColor,
  type AccessInfo,
  emptyAccess,
...
function CircleStat({
  ...
  const offset =
    circ - (Math.min(100, Math.max(0, percentage)) / 100) * circ
    ...
    <div className="flex flex-col items-center gap-1.5">
      <div className="relative w-14 h-14">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <span
            className={`font-sora font-bold text-sm leading-none ${textColor}`}
          >
            {value}
          </span>
        </div>
...
export default function Dashboard() {
  ...
  const [access, setAccess] =
    useState<AccessInfo>(emptyAccess)
  ...
  const [upgradeReason, setUpgradeReason] =
    useState<
      'explorer_locked' | 'no_lectures_left' | 'needs_premium'
    >('explorer_locked')
  ...
  useEffect(() => {
    const init = async () => {
      ...
      try {
        lectures = JSON.parse(
          localStorage.getItem('recordingsMetadata') || '[]'
        ).length
      } catch {
        lectures = 0
      }
      ...
      try {
        ...
        try {
          ...
          // Ignore malformed recordings metadata
        }
      ...
      // -----------------------------
      if (
        !localStorage.getItem('studia_onboarded')
      ) {
        setTimeout(
  ...
  const isPaidPlan =
    ['excellence', 'valedictorian'].includes(plan)

  const paidLeft =
    paidLecturesRemaining(access)

  const explorerLeft =
    explorerLecturesRemaining(access)
  ...
  const usageBar = (() => {
    if (isExplorer) {
      const used =
        access.freeCreditsUsed || 0

      return {
        used,
        total: 3,
        pct: Math.round((used / 3) * 100),
        color:
          used >= 3
            ? 'bg-red-500'
            : used >= 2
    ...
    if (isPaidPlan) {
      const used =
        access.lecturesUsed || 0

      const total =
        access.lectureAllowance || 0
  ...
  const cards = [
    {
      ...
      desc: 'Smart AI recording',
      path: '/recording',
      color: 'from-indigo-premium',
    },
    {
      icon: BookOpen,
      title: 'My Notes',
      ...
      path: '/notes',
      color: 'from-purple-premium',
    },
    {
      icon: BarChart3,
      title: 'Test Yourself',
      desc: 'AI practice tests',
      path: '/quiz',
      color: 'from-mint',
    },
    {
    ...
    {
      // FIXED: Brain is now properly imported above
      icon: Brain,
      title: 'Knowledge Map',
      desc: 'What you know, connected',
      path: '/knowledge-map',
      color: 'from-purple-premium',
    },
  ]
      ...
      <nav className="sticky top-0 z-40 bg-white/80 backdrop-blur-md border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <span className="font-sora font-bold text-navy text-base sm:text-lg hidden sm:inline">
              STUDIA AI
            </span>
        ...
        {pageLoading ? (
          ...
          >
            ...
            <div>
              ...
              <p className="text-gray-500 text-sm sm:text-base">
                {stats.streak > 0 ? (
                  <>
                    On a{' '}
                    <span className="font-bold text-indigo-premium">
            ...
            <div
              className={`rounded-2xl p-5 sm:p-6 border-2 cursor-pointer transition-colors ${
                isLocked
                  ...
                  : plan === 'valedictorian'
                  ? 'bg-gradient-to-r from-warning/10 to-red-500/10 border-warning/40'
                  : plan === 'excellence'
                  ? 'bg-gradient-to-r from-mint/10 to-light-blue/10 border-mint/30'
                  : plan === 'achiever'
                  ? 'bg-blue-50/50 border-light-blue/30'
              ...
              onClick={() => {
                if (isLocked) {
                  ...
                  setUpgradeReason('no_lectures_left')
                  setShowUpgradeModal(true)
                }
              }}
            >
              ...
              <div className="flex items-start justify-between gap-4 flex-wrap">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-2 mb-1 flex-wrap">
                    ...
                    <span
                      className={`font-sora font-bold text-lg ${getPlanColor(
                        plan
                      )}`}
                    >
                      {getPlanLabel(plan)}
                    ...
                    {access.subscriptionStatus === 'active' &&
                      isPaidPlan && (
                        <span className="text-[10px] bg-mint/20 text-mint px-2 py-0.5 rounded-full font-semibold">
                          ACTIVE
                        </span>
                      )}

                    {isLocked && (
                      <span className="text-[10px] bg-red-500/20 text-red-600 px-2 py-0.5 rounded-full font-semibold">
                        LOCKED
                      </span>
                    )}
                  </div>
                  ...
                  {isLocked ? (
                    <div className="flex items-start gap-2">
                      ...
                      <p className="text-sm text-red-700">
                        All 3 free lectures used. Tap to unlock AI features.
                      </p>
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-sm text-gray-600">
                        ...
                        of 3 free lectures remaining · lifetime, no reset
                      </p>
                      ...
                      {usageBar && (
                        <div className="w-full bg-gray-200 rounded-full h-2">
                          ...
                          <div
                            className={`${usageBar.color} h-2 rounded-full transition-all`}
                            style={{
                              width: `${usageBar.pct}%`,
                            }}
                          />
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-sm text-gray-600">
                        ...
                        <span className="font-bold text-navy">
                          {usageBar.total - usageBar.used}
                        </span>{' '}
                        of {usageBar.total} lectures remaining
            ...
            <div className="bg-gradient-to-r from-purple-500/10 to-pink-500/10 border-2 border-purple-500/20 rounded-2xl p-5 sm:p-6">
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="font-sora font-bold text-navy text-base mb-0.5">
                    Refer and Earn — Free AI Credits
                  </p>
            ...
            <div>
              ...
              <h2 className="font-sora font-bold text-xl sm:text-2xl text-navy mb-4 sm:mb-6">
                Quick Actions
              </h2>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 sm:gap-4">
                ...
                {cards.map((card, i) => (
                  ...
                  >
                    ...
                    <div
                      className={`bg-gradient-to-br ${card.color} to-transparent rounded-2xl p-4 sm:p-5 border border-gray-200 hover:border-indigo-premium/50 hover:shadow-lg transition h-full ${
                        isLocked &&
                        card.path !== '/payments'
                          ? 'opacity-60'
                          : ''
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h2 className="font-sora font-bold text-2xl sm:text-3xl mb-3">
                  Pro Tip
                </h2>
