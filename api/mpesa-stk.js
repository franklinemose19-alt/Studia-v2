...
// Set MPESA_ENV=production in Vercel once you're fully ready to go live —
// this one variable switches both Daraja URLs below from sandbox to
// production. Nothing else in this file needs to change again.
...
export default async function handler(req, res) {
  ...
  try {
    ...
    const stkPayload = {
      ...
      Password: password,
      Timestamp: timestamp,
      // Buy Goods / Till — not Paybill. Safaricom confirmed your shortcode
      // is a Till number; CustomerPayBillOnline only works against a real
      // Paybill shortcode.
